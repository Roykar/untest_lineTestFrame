...
class SendEmail():
    ...
    def __init__(self, receiver, subject, ):
        ...
        self.smtpserver = self.data.get_email_163('smtpserver')
        self.username = self.data.get_email_163('username')
        self.password = self.data.get_email_163('password')
        self.sender = self.data.get_email_163('sender')
        '''
        初始化邮件发送对象
        ...
        self.msg['From'] = '{} <{}>'.format(self.username, self.username)
...
if __name__ == '__main__':
    em_obj = SendEmail(['286955385@qq.com'],'测试邮件')
